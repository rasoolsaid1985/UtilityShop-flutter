...
getfirstRecommend(firstNotifier firstnotifier) async{

  QuerySnapshot snapshot = await FirebaseFirestore.instance.collection('recommended').get();
  ...
  firstnotifier.productList = _productList;
}